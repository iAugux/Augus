...
public class PasscodeLockViewController: UIViewController, PasscodeLockTypeDelegate {
    ...
    public override func viewDidLoad() {
        ...
        cancelButton?.setTitle(localizedStringFor("PasscodeLockCancel", comment: ""), for: UIControlState())
        deleteSignButton?.setTitle(localizedStringFor("PasscodeLockDelete", comment: ""), for: UIControlState())
    }
    ...
    internal func updatePasscodeView() {
        ...
        cancelButton?.isUserInteractionEnabled = !(cancelButton?.isHidden ?? true)
    }
